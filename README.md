...
# 🧹 Messy1 Table - SQL Data Cleaning Project

**Real-world Data Cleaning** using MySQL

![SQL Cleaning]<img width="1920" height="1014" alt="Screenshot (1255)" src="https://github.com/user-attachments/assets/aa33cf41-2697-4fff-bfa6-c9f3f0959fb8" />
<img width="1920" height="1017" alt="Screenshot (1254)" src="https://github.com/user-attachments/assets/4adbc4b8-5c75-487c-856a-d9ec66450a1c" />
<img width="1920" height="1014" alt="Screenshot (1253)" src="https://github.com/user-attachments/assets/a066ec23-a16a-4459-914f-fdbb5f478e19" />
<img width="1920" height="1014" alt="Screenshot (1252)" src="https://github.com/user-attachments/assets/7e6fc61c-4343-4301-9fb9-548369f3dd87" />
<img width="1920" height="1017" alt="Screenshot (1251)" src="https://github.com/user-attachments/assets/9a107ef0-8e20-4259-9452-7f92cd323b70" />


---

### 🎯 Objective
Cleaned and standardized a highly messy customer transaction table containing inconsistent data formats, missing values, and anomalies.

---

### ✅ Cleaning Operations Performed

| Column            | Challenges Handled                     | Methods Used |
|-------------------|----------------------------------------|--------------|
| `Full_Name`       | Extra spaces, special chars, wrong case | Regex, TRIM, CONCAT |
| `Email`           | Double `@`, wrong domain               | REGEXP_REPLACE |
| `Phone`           | Multiple formats, country codes        | Multiple REPLACE |
| `Address`         | Inconsistent casing & format           | REGEXP + String functions |
| `Order_Date`      | Multiple formats (DD-MM-YY, MM/DD/YYYY)| STR_TO_DATE |
| `Order_Amount`    | Currency symbols, commas               | REGEXP_REPLACE |

---

### 📊 Final Clean Table Schema

![sql file][CLEANING 2_MESSY1 TABLE_FULL-NAME.sql](https://github.com/user-attachments/files/28356876/CLEANING.2_MESSY1.TABLE_FULL-NAME.sql)
USE SELF_PRACTICE;
SELECT * FROM MESSY1;
DESCRIBE MESSY1;
